...
def grade_review(probelm_uuid, window):
    """
    a function that allows you to grade the review
    ...
    initial_value='10',
    tooltip='Choose the grade to give',
    ...
    if event == "Submit":
        grade_review_process = core.lms_call(["wtc-lms","grade_review", probelm_uuid, f"{values['-GRADE-']}"])
