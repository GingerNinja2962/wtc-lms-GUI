...
def problem_selection_layout():
    ...
    """
    entry_list = [mProblem for mProblem in problems_data.review_problems]
    ...
    layout = [
        ...
        [ sg.Column([ [sg.Listbox(values=entry_list, size=(30,20), key='-PROBLEM-', enable_events=True)] ]),
        sg.Column([ [sg.Frame('Search all assignments', Toggle_all_Frame, title_color='#FF8C00')],
        [ sg.Frame('Filters', Filter_Frame, title_color='#FF8C00', key='-FILTERS-')],
        ...
        sg.Button('Review details', disabled=True, tooltip='List the details of the review'),
