...
class baseWindowClass(metaclass=DocInheritMeta(style="numpy_with_merge", include_special_methods=True)):
    ...
    ----------
        ...
        elementJustification : str
            The type of justification to use on all elements on the
            window.
        location : tuple
            The x and y values to place the top left courner of the
            window.
        running : bool
    ...
    -------
        ...
        read()
            Read the user input and map input to functionality of
    ...
    def __init__(self):
        """
        The constructor for baseWindowClass.
        """
    ...
    def read(self):
        """
        Read the user input and map input to functionality of window
        where possible.
        """
