...
class baseAssignmentClass(metaclass=DocInheritMeta(style="numpy_with_merge", include_special_methods=True)):
    """
    A base class to use for a downloading message if you are downloading data from lms.

    Attributes
    ----------
        downloadingMessage : object
            The PySimpleGUI object that has been opened.
    ...
    def __init__(self):
        ...
        ----------
            downloadingMessage : object
                The PySimpleGUI object that has been opened to display a downloading message.
        """
    ...
    def openMessage(self, dataType="assignment"):
        ...
        ----------
        dataType : str
            This is the type of data being downloaded, by default 'assignment'.
        """
        self.downloadingMessage = sg.Window(f"Downloading your {dataType}",
            [
                [ sg.Text(f"\nYour {dataType} is being downloaded.") ],
                [ sg.Text(f"\Downloading your {dataType} may take a minute or two") ],
